// Newspaper Editorial Typography - Classic Editorial Layout Style
// 報紙編輯排版 - 經典編輯佈局風格

export const newspaperEditorialTemplates = [
  {
    id: 'newspaper-editorial',
    title: 'styles.typography.editorial.newspaperEditorial.title',
    description: 'styles.typography.editorial.newspaperEditorial.description',
    ...
    colorScheme: 'styles.typography.editorial.newspaperEditorial.colorScheme',

    // ✨ 模板級 CustomPrompt（用於高精度復刻報紙編輯卡片）
    customPrompt: {
      'zh-CN': `你现在是一名资深 UI 设计师兼前端工程师，请生成一个与当前「报纸编辑排版 Demo」界面风格高度接近的 Newspaper/Editorial Typography 模块。
...
export default newspaperEditorialTemplates;
