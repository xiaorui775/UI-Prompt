// Classic Vintage - Retro Newspaper Style
// 经典复古 - 复古报纸风格

import { retroVintageFullPageHTML, retroVintageFullPageStyles } from './vintageNewspaperFullPage';
...
export const vintageNewspaper =
  {
    ...
    // ✅ 階段 3.2: 改用動態加載 ID
    fullPageHTML: retroVintageFullPageHTML,
    fullPageStyles: retroVintageFullPageStyles,
    colorScheme: {
      'zh-CN': '深棕褐色 (#8B4513)、米黄色 (#F5DEB3)、复古橘红 (#FF6347)、暗褐背景 (#3B2F2F)',
      'en-US': 'Deep sepia (#8B4513), beige (#F5DEB3), vintage red-orange (#FF6347), dark brown background (#3B2F2F)'
    },

    // 模板级 customPrompt（长版 Prompt，可直接给 LLM 高精度复刻 UI）
    customPrompt: {
      'zh-CN': `你现在是一名资深 UI 设计师兼前端工程师，请生成一个与当前「Vintage Newspaper 复古报纸页面」示例风格高度接近的 UI。
