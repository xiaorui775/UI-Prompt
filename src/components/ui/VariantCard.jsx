      ...
      <div className="px-4 pb-4">
        <div
          className={`
            ...
            ${onPreview ? 'cursor-pointer hover:border-purple-400 hover:shadow-md transition-all duration-200 relative group' : ''}
          `}
      ...
      <div className="px-4 pb-4">
        {onGetPrompt && (
          <button
            ...
            className="w-full px-4 py-2.5 bg-black hover:bg-gray-800 text-white rounded-lg text-sm font-medium transition-colors flex items-center justify-center gap-2 shadow-sm hover:shadow-md"
          >
